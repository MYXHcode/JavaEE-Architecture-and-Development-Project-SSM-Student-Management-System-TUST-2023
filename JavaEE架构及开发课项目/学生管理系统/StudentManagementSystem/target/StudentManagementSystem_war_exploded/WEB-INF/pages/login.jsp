            ...
            <div id="wrapper">
                <div id="stu_login" class="animate form">
                    <form autocomplete="on">
                        <h1>登录</h1>
                        <p>
                            <label for="stu_ID" class="uname" data-icon="u"> 用户名 </label>
                            <input id="stu_ID" name="id" required="required" type="text" placeholder="username"/>
                        </p>
                        <p>
                            <label for="stu_password" class="youpasswd" data-icon="p"> 密码  </label>
                            <input id="stu_password" name="password" required="required" type="password"
                                   placeholder="password"/>
                        </p>
                        <p class="login button">
                            <input type="button" value="登录" id="stu_login_btn"/>
                        </p>
                        <p class="character">
                            <a>学生登录</a>
                        </p>
                ...
                <div id="tea_login" class="animate form">
                    <form autocomplete="on">
                        <h1>登录</h1>
                        <p>
                            <label for="tea_ID" class="uname" data-icon="u"> 用户名 </label>
                            <input id="tea_ID" name="id" required="required" type="text" placeholder="username"/>
                        </p>
                        <p>
                            <label for="tea_password" class="youpasswd" data-icon="p"> 密码 </label>
                            <input id="tea_password" name="password" required="required" type="password"
                                   placeholder="password"/>
                        </p>
                        <p class="login button">
                            <input type="button" value="登录" id="tea_login_btn"/>
                        </p>
                        <p class="character">
                            <a>教师登录</a>
                        </p>
                ...
                <div id="sec_login" class="animate form">
                    <form autocomplete="on">
                        <h1>登录</h1>
                        <p>
                            <label for="sec_ID" class="uname" data-icon="u"> 用户名 </label>
                            <input id="sec_ID" name="id" required="required" type="text" placeholder="username"/>
                        </p>
                        <p>
                            <label for="sec_password" class="youpasswd" data-icon="p"> 密码 </label>
                            <input id="sec_password" name="password" required="required" type="password"
                                   placeholder="password"/>
                        </p>
                        <p class="login button">
                            <input type="button" value="登录" id="sec_login_btn"/>
                        </p>
                        <p class="character">
                            <a>教秘登录</a>
                        </p>
